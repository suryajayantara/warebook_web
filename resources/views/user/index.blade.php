...
@section('contents')
    <div class="bg-[#FBFDFF] h-80 w-full">
        ...
        <div class="flex items-center shadow-lg h-16 w-[75%] bg-[#EEEFF3] mx-auto  rounded-md -mt-9 z-20">
            ...
            <input class="bg-[#EEEFF3] h-16 w-full rounded-r-md focus:outline-none"
                placeholder="Cari Judul Repositori Disini" type="text" name="" id="">
        </div>
    </div>
        ...
        <div class="mt-14 grid grid-cols-5 gap-4">
            ...
            @else
                @foreach ($journal as $item)
                    <a href="/dosen/journalTopic/index/{{ $item->id }}"
