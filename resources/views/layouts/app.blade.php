...
<body class="font-nunito bg-[#EEEFF3] text-[#333333]">
    <header class="border-b  border-gray-100  bg-white">
        <div class="flex items-center justify-between w-[95%] mx-auto h-16 max-w-screen-2xl sm:px-6 lg:px-8">
            ...
            <div class="flex items-center justify-end flex-1">
                <nav
                    class="hidden lg:text-gray-500 lg:tracking-wide lg:font-semibold lg:text-base lg:space-x-6 lg:flex">
                    <a href="/home"
                    ...
                    <a href="
              @if (Auth::user()->hasRole('student')) {{ route('studentRepository.index') }}
              @else
                {{ route('lectureRepository.index') }} @endif
              "
                        class="block h-16 mx-2 leading-[4rem] border-b-4 border-transparent opacity-50 hover:opacity-100 hover:border-blue-600 duration-300">
                        Repositori
                    </a>
                    <div class="py-5">
                        <button id="dropdownDividerButton" data-dropdown-toggle="dropdownDivider"
                            class="bg-blue-600 px-3 py-1 font-extrabold text-white rounded-md">Akunku</button>
                    </div>
                </nav>
            </div>
        </div>
    ...
    <div id="dropdownDivider"
        class="hidden z-10 w-32 bg-white rounded divide-y divide-gray-100 shadow dark:bg-gray-700 dark:divide-gray-600"
