...
<body class="text-[#333333] bg-[#F5F5F5]">
    ...
    <div class="bg-white w-[35%] mx-auto px-16 pb-8 pt-10 shadow-md rounded-sm">
        ...
        <div class="flex">
            <a href="{{ route('register.create', ['type' => 'lecture']) }}"
                class="w-1/2 mr-2 shadow-sm h-44 flex flex-col items-center rounded-xl bg-[#0984E3]">
                <img class="h-32" src="{{ asset('img/design/teacher.svg') }}" alt="">
                <h1 class="font-bold text-white text-xl">Pengajar</h1>
            </a>
            <a href="{{ route('register.create', ['type' => 'student']) }}"
                class="w-1/2 ml-2 shadow-sm h-44 rounded-xl flex flex-col items-center bg-[#E2AA40]">
