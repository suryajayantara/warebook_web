...
@section('contents')
    ...
    <div class="bg-white w-[40%] mx-auto  my-10 px-10 pb-8 pt-10 shadow-md rounded-sm" >
        ...
        <form enctype="multipart/form-data" action="{{ route('thesis.store') }}" method="post" class="flex flex-col">
            ...
            <input class="font-semibold  h-12 mt-3 mb-2 text-slate-500 px-4 border-b-2 ease-in-out delay-150 focus:border-slate-600 focus:outline-none duration-200" type="number" placeholder="Tahun Pembuatan" name="created_year" id="created_year" required>
