...
@section('contents')
    ...
    <div class="bg-white w-[40%] mx-auto  mt-10 px-10 pb-8 pt-10 shadow-md rounded-sm" >
        ...
        <form enctype="multipart/form-data" action="" method="post" class="flex flex-col">
            ...
            <input class="border rounded-md file:bg-slate-600 my-2 focus:outline-none cursor-pointer file:text-white file:font-bold file:border-none file:h-12 file:w-[25%]" type="file" name="" id="thumbnail">
