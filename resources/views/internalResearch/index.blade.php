    ...
    <div class="container mx-auto w-[70%] ">
        <div class="flex flex-col mt-20">
            <div class="flex flex-col">
                ...
                <div class="duration-300 opacity-80" id="abstract">
                    {{ date('l, d F Y', strtotime($data->project_started_at))}} - {{ date('l, d F Y', strtotime($data->project_finish_at))}} 
                </div>          
            ...
            <div class="flex mt-5 mb-2">
                ...
                @if (Auth::user()->id == $data->users_id)
                        ...
                        <a href="{{ route('internalResearch.edit', ['internalResearch' => $data->id])}}">
                            <button type="button" class="mx-1 float-right inline-block px-4 py-2 bg-[#FDCB6E] text-white font-bold text-sm leading-tight rounded shadow-md hover:bg-blue-700 hover:shadow-lg focus:bg-blue-700 focus:shadow-lg focus:outline-none focus:ring-0 active:bg-blue-800 active:shadow-lg transition duration-150 ease-in-out">
                                Edit Repo
                            </button>
                        </a>
                    @endif
            ...
            <div class="grid grid-cols-1 gap-3 overflow-auto duration-300 mb-3" id="document">
                <a href="{{asset($data->proposal_url)}}" class="flex h-[5rem] w-full bg-slate-50 shadow-sm rounded-md items-center">
             ...
             <div class="grid grid-cols-1 gap-3 overflow-auto duration-300 mb-20" id="document">
                <a href="{{asset($data->document_url)}}" class="flex h-[5rem] w-full bg-slate-50 shadow-sm rounded-md items-center">
                <img class="bg-[#FF7675] p-2 h-[3.5rem] w-[3.5rem] m-2 mx-2 rounded-md" src="{{asset('img/icon/document.svg')}}" alt="">
                    <div class="overflow-hidden mt-1">
