                    ...
                    <div class="card-body">
                        <form enctype="multipart/form-data" action="{{ route('users.update', $data->id) }}" method="post">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <select name="role" id="id_faculty"
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input value="{{ $data->user->name }}" name="name" type="text"
                                        class="form-control" placeholder="Nama Jurusan" required />
                                    @error('name')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input value="{{ $data->unique_id }}"name="unique_id" type="text"
                                        class="form-control" placeholder="Nomor Idntitas" required />
                                    @error('unique_id')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <select name="studies_id" id="id_faculty"
                                        class="form-control @error('studies_id') is-invalid @enderror"
                                        aria-label="Default select example" required>
                                        <option value="" selected>Program Studi</option>
                                        <option value="{{ $data->study_id }}" selected>{{ $data->study->studies_name }}
                                        </option>
                                        @foreach ($studies_data as $studies)
                                            @if ($studies->id != $data->study_id)
                                                <option value="{{ $studies->id }}">{{ $studies->studies_name }} -
                                                    {{ $studies->departements->departement_name }}</option>
                                            @endif
                                        @endforeach
                                    </select>
                                    @error('studies_id')
