    ...
    <div class="row  mt-10">
        <div class="col-xxl">
            <div class="card mb-4">
              ...
              <div class="card-body">
                <form enctype="multipart/form-data" action="{{ route('manageJournal.update', $data->id) }}" method="post">
                    @csrf
                    @method('PUT')
                  ...
                  <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                        <input value="{{$data->subject}}" name="subject" type="text" class="form-control" placeholder="Nama Jurusan" />
                        @error('studies_name')
                            <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                            </span>
