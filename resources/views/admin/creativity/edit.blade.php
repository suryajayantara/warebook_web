    ...
    <div class="row  mt-10">
        <div class="col-xxl">
            <div class="card mb-4">
              ...
              <div class="card-body">
                <form enctype="multipart/form-data" action="{{ route('manageCreativity.update', $data->id) }}" method="post">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="row mb-3">
                      ...
                      <div class="col-sm-10">
                          <input value="{{$data->creativity_type}}" name="creativity_type" type="text" class="form-control" placeholder="Nama Jurusan" />
                          @error('studies_name')
                  ...
                  <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                        <input value="{{$data->aliases}}" name="aliases" type="text" class="form-control" placeholder="Nama Jurusan" />
                        @error('studies_name')
                            <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                            </span>
                  ...
                  <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                        <input value="{{$data->supervisor}}" name="supervisor" type="text" class="form-control" placeholder="Nama Pembimbing  " />
                        @error('studies_name')
                            <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                            </span>
