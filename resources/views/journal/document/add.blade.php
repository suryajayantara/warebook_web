...
@section('contents')
    ...
    <div class="bg-white w-[40%] mx-auto  mt-10 px-10 pb-8 pt-10 shadow-md rounded-sm" >
        ...
        <form class="flex flex-col" enctype="multipart/form-data" action="{{ route('journalDocument.store')}}" method="POST">
            ...
            <input class="h-12 mt-3 mb-2 px-4 border-b-2 ease-in-out delay-150 focus:border-slate-600 focus:outline-none duration-200" type="number" placeholder="Tahun Terbit" name="year" id="year" required>
